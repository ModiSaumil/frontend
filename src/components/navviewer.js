    ...
    return (
        <div>
            <header class="header">
                ...
                <a className='logout'>Welcome, <Link to={"/profilev/"+JSON.parse(auth)._id}>{JSON.parse(auth).fname} {JSON.parse(auth).lname} </Link></a>
                <a><button class="dropbtn"><Link to="/home">Home</Link></button> </a>
                <a><button class="dropbtn"><Link to="/photoglistv">Photographers</Link></button> </a>
