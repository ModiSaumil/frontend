...
const Changepasswordviewer = () => {
    ...
    return (
        <div className="divsgn" style={{marginTop:"10%"}}>
            ...
            <Link to={"/home"}><button style={{padding:"5px", width: "70px",backgroundColor: "orange", border:"none",borderRadius:"10px",cursor: "pointer"}} type="button" className="btnsn">cancel</button></Link>
...
export default Changepasswordviewer;