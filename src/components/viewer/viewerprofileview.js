        ...
        <section class="categories" id="categories" style={{ marginTop: "5%" }}>
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <button style={{ padding: "5px", width: "70px", backgroundColor: "orange", border: "none", borderRadius: "10px", cursor: "pointer" }} className="btnsn" type="button"><Link to={"/profilevview/" + JSON.parse(auth)._id}>Update</Link></button>
