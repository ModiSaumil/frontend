...
const UpdatePhoto = () => {
    ...
    return (
        ...
        <div className="divsgn" style={{marginTop:"10%"}}>
            ...
            <Link to={"/photolist"}><button type="button" style={{padding:"5px", width: "70px",backgroundColor: "orange", border:"none",borderRadius:"10px",cursor: "pointer"}} className="btnsn">cancel</button></Link>
