...
const ProductList = () => {
    ...
    return (
        <div style={{ marginTop: "10%" }}>
            ...
            <input className="inputbox" onChange={searchHandle} type="text" placeholder='enter to search..'></input>
                ...
                <tbody>
                    {
                        photo.length > 0 ? photo.map((item, index) => (
                            <tr key={item._id} className='trcss img'>
                                ...
                                <button style={{padding:"5px", width: "70px",backgroundColor: "orange", border:"none",borderRadius:"10px",cursor: "pointer"}}><Link to={"/photoupdate/" + item._id}>Update</Link></button>&nbsp;&nbsp;&nbsp;&nbsp;
                                <button style={{padding:"5px", width: "70px",backgroundColor: "orange", border:"none",borderRadius:"10px",cursor: "pointer"}}><Link to={"/photoviewf/" + item._id}>View</Link></button></td>
                            </tr>
                ))
