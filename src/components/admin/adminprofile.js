        ...
        <section class="categories" id="categories">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <button style={{ padding: "5px", width: "70px", backgroundColor: "orange", border: "none", borderRadius: "10px", cursor: "pointer" }} className="btnsn" type="button"><Link to={"/adminprofileview/" + JSON.parse(auth)._id}>Update</Link></button>
                    {/* <button onClick={addimage} type="button" className="btnsn">Add photo</button> */}
